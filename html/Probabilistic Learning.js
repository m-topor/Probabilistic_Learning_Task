...
function experimentInit() {
  ...
  quest = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined, 
    pos: [0, 0.6], height: 0.15,  wrapWidth: undefined, ori: 0,
    color: new util.Color('black'),  opacity: 1,
    depth: 0.0 
  });
  ...
  letter_string = new visual.TextStim({
    ...
    font: 'hiragana tfb',
    units : undefined, 
    pos: [0, 0.1], height: 0.25,  wrapWidth: undefined, ori: 0,
    color: new util.Color('black'),  opacity: 1,
    depth: -1.0 
  });
  ...
  number_string = new visual.TextStim({
    ...
    font: 'Arial',
    units : undefined, 
    pos: [0, (- 0.2)], height: 0.2,  wrapWidth: undefined, ori: 0,
    color: new util.Color('black'),  opacity: 1,
    depth: -2.0 
  });
...
function Prep_InstructionRoutineBegin() {
  ...
  for (const thisComponent of Prep_InstructionComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function preparationLoopBegin(thisScheduler) {
  ...
  for (const thisPreparation of preparation) {
...
function letterMasterLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLetterMaster of letterMaster) {
...
function prep_feedbackRoutineBegin() {
  ...
  for (const thisComponent of prep_feedbackComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Prep_overRoutineBegin() {
  ...
  for (const thisComponent of Prep_overComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Practice_InstructionRoutineBegin() {
  ...
  for (const thisComponent of Practice_InstructionComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Practice_overRoutineBegin() {
  ...
  for (const thisComponent of Practice_overComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Learning_CheckRoutineBegin() {
  ...
  for (const thisComponent of Learning_CheckComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function task_overRoutineBegin() {
  ...
  for (const thisComponent of task_overComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
